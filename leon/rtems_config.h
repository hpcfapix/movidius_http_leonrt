...
BSP_SET_CLOCK(12000, 266000, 1, 1, DEFAULT_RTEMS_CSS_LOS_CLOCKS, DEFAULT_RTEMS_MSS_LRT_CLOCKS | DEV_CSS_GETH | DEV_CSS_I2C0, UPA_SHAVE_L2, 0, 0);
/* mss clock need to be set enabling GETH and I2C0 */
